...
<div class="max-w-3xl mx-auto">
  <div class="bg-white rounded-2xl shadow p-6 border">
    <div class="text-xl font-extrabold text-gray-900 mb-6">Mi Perfil de Cliente</div>
    ...
    <form id="profileForm" class="space-y-4">
      ...
      <div class="pt-4 border-t">
        <label class="block text-sm font-medium text-gray-700 font-bold mb-2">Cambiar mi Contraseña</label>
      ...
      <div class="pt-4 flex items-center justify-end border-t border-gray-100">
        <button type="submit"
          ...
          id="btnSave">Guardar Mi Información</button>
      </div>
    </form>
  </div>
</div>
...
<script>
  const API_URL = '<?= app_url('api/cliente/ajustes.php') ?>';
  $(function () {
