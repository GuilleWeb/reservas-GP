      ...
      <div class="bg-white rounded-2xl shadow p-5 border">
        ...
        <form id="planForm" class="mt-4 space-y-3">
          ...
          <div>
            ...
            <textarea class="border rounded-lg p-2 w-full" id="descripcion" name="descripcion" rows="3"></textarea>
          </div>
      ...
      <div class="bg-white rounded-2xl shadow border p-5">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <div class="mt-4 grid grid-cols-1 md:grid-cols-6 gap-3">
            ...
            <div id="totalReg" class="text-sm text-teal-600 self-center"></div>
          </div>
        </div>
        ...
        <div class="flex-1 overflow-auto bg-gray-50 rounded-lg border border-gray-100">
          <table class="w-full text-left border-collapse min-w-max">
            ...
            <tbody id="planesTable" class="divide-y"></tbody>
          </table>
        </div>
